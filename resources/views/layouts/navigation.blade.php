            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none transition">
                                <div>{{ optional(Auth::user())->name ?? 'Usuário' }}</div>
                                <div class="ml-1">
                ...
                @else
                    ...
                    <div class="space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="text-sm text-gray-600 hover:text-gray-900">Registrar</a>
                    </div>
                @endauth
            </div>

            <!-- Mobile menu button (não utilizado agora) -->
